require "trb1-uber/options"
require "trb1-representable/populator"
  ...
  module Representable
    ...
    private
      def setup!(options, &block)
        ...
        Trb1::Representable::Populator.apply!(options)
      ...
      def runtime_options!(options)
        ...
        for name, value in options
          value = Trb1::Uber::Options::Value.new(value) if dynamic_options.include?(name)
