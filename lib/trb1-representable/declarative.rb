module Trb1
  module Representable
    module Declarative
      ...
      include ::Trb1::Declarative::Schema::DSL # ::property
      include ::Trb1::Declarative::Schema::Feature
      include ::Trb1::Declarative::Heritage::DSL
      ...
      def definitions
        @definitions ||= Config.new(Trb1::Representable::Definition)
      end
